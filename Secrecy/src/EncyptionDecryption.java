...
class BackendWork{
    ...
    // Created a array for default user. This user will be able to access the system with there ID and Password
    static String[][] userDetails = {{"ANKUSH0016", "A6ANKUSH"},{"SARVESH0019", "A6SARVESH"}, {"SHAIL0022", "A5SHAIL"}, {"DEV0023", "A5DEV"}};
